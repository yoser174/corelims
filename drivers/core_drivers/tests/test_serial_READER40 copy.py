...
"""
data = ' ID:1'+ CRLF
data = data +' Date:08-20-2019 06:53 am  '+ CRLF
data = data +' Operator: 01     '+ CRLF
data = data +' No.000001             '+ CRLF
data = data +' LEU       -              neg'+ CRLF
data = data +' NIT       -              neg'+ CRLF
data = data +' URO       -       0.2  mg/dL'+ CRLF
data = data +' PRO       -              neg'+ CRLF
data = data +' pH           7.5'+ CRLF
data = data +' BLO       -              neg'+ CRLF
data = data +' SG         1.000'+ CRLF
data = data +' KET       -              neg'+ CRLF
data = data +' BIL       -              neg'+ CRLF
data = data +' GLU       -              neg'+ CRLF
data = data +'*ASC       -              neg'+ CRLF
data = data +''+CRLF
