...
class RequestHandler(ASTMProtocol):
    ...
    def handle_message(self, message):
        logging.debug('handle_message(%s)' % message)
        logging.debug('is_chunked_transfer [%s]' % self.is_chunked_transfer)
        logging.debug('_chunks [%s]' % self._chunks)
