...
from .models import Tests,TestPrices,TestGroups,Profile,ProfileTests,Priority,Insurance,Doctors, \
...
Service,Workarea,WorkareaTestGroups,Menus,BDJenisDarah,BDGrupJenisDarah, \
Supplier,Location,Vendor,ProductLot,TemperatureCondition, \
Unit,Product,Storage,StockIn,StockInLot,UsedAt,UsingProduct,UserExtension,ReturningProduct, ProductGroup, \
PackageCondition,PhysicalCondition, MBTests, MBCultureMedia, MBTestCultureMedia, MBResults,MBAntibiograms,MBAntibiogramAntibiotics,MBAntibioticMethods, \
MBAntibiotics,MBAntibioticFamilies,RequestNewReasons,\
PBSTest,PBSResult, Labels, InstrumentBatch
...
class TestRefAdmin(admin.ModelAdmin):
    list_display = ('test','gender','age_from','age_from_type','age_to','age_to_type','operator', \
                    'any_age','lower','upper','panic_lower','panic_upper','operator_value','alfa_value','special_info')
