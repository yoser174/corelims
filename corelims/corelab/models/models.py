...
class LabelPrinters(models.Model):
    ...
    class Meta:
        verbose_name = _("Label printer")
        verbose_name_plural = _("Label printers")
        # permissions = (("view_labelprinters", "Can view label printers"),)
        ordering = ["name"]
...
class Instruments(models.Model):
    ...
    class Meta:
        ...
        # permissions = (("view_instruments", "Can view instruments"),)
        ordering = ["name"]
...
class OrderResults(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = "Order Results"
